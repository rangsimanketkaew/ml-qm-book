...
ของวงการปัญญาประดิษฐ์เลยก็ว่า ตามที่ได้อธิบายไว้คร่าว ๆ ในหัวข้อ \ref{sec:ann} แล้วว่าโครงข่ายประสาทเทียมนั้นเป็นการเลียนแบบการทำงาน%
...
Keras ซึ่งเป็น Library ที่ถูกติดตั้งและพัฒนาให้เป็น API หลักของ TensorFlow ในการสร้างโมเดล Neural Network
\footnote{ดูรายละเอียดการสร้างโมเดลแบบ Sequential ของ Keras ได้ที่ \url{https://keras.io/guides/sequential_model/}}
