...
พิจารณากรณีง่าย ๆ ด้วยโครงสร้างแบบเล็ก ๆ ก่อน

\begin{figure}[H]
    \centering
    \subfloat[ชั้นการเรียนรู้ (Learning Layer)\label{fig:plot_simple_reg_1}]{
        \includegraphics[width=0.4\linewidth]{fig/nn_layer.png}}
    \hspace{1em}
    \subfloat[โครงข่ายแบบค่าน้ำหนักหลายตัว\label{fig:plot_simple_reg_2}]{
        \includegraphics[width=0.4\linewidth]{fig/nn_w_matrices.png}}
    \caption{}
