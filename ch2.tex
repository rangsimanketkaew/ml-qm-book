...
\noindent ถ้าหากฟังก์ชันไม่สอดคล้องกับเงื่อนไขทั้งสองข้อด้านบน ฟังก์ชันนั้นจะมีความไม่เป็นเชิงเส้น (Non-linearity)

%--------------------------
\section{Linear Classification}
\label{sec:lin_class}
\idxen{Supervised Learning!Linear Classification}
%--------------------------
