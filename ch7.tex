...
\begin{figure}[H]
    \centering
    \subfloat[กำหนดระยะห่างระหว่างอะตอม\label{fig:diatomic_mol}]{
...
\begin{figure}[H]
    \centering
    \subfloat[กำหนดระยะห่างระหว่างอะตอม\label{fig:3_body_mol}]{
    ...
    \caption{โมเลกุลสามอะตอมแบบเชิงเส้นตรงร่วม}
...
ค่าคู่ควบของกระบวนการนอนอะเดียแบติก (Nonadiabatic Coupling)
