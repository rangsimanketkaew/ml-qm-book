...
โดยในขั้นตอนการพลอต Wavefunction นั้นเราจะทำการสร้างฟังก์ชันสำหรับ $R_{nl}(r)$ และ $Y_{lm}(\theta, \phi$ ตามลำดับ
...
\noindent โดยจะได้พลอตตามภาพที่ \ref{fig:wfn_hydro_radial} ขั้นตอนต่อไปคือทำการเพิ่ม Interactive Widget สำหรับพลอตที่%
...
\noindent ทำการกำหนดตั้งค่าสำหรับการพลอตแบบ 3 มิติ โดยกำหนดให้ \pyinline{projection='3d'} สำหรับ Matplotlib
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fig/wfn_hydro_angular.png}
