...
และ $\theta^{T}$ เป็นเวกเตอร์ของพารามิเตอร์ $\theta_{i}$ ดังนี้
...
($\theta^{T}\phi(x)$ ก็คือโมเดลของเรานั่นเอง) ซึ่งสามารถทำได้โดยใช้ Stocahstic Gradient Descent โดยสมการมีหน้าตาดังต่อไปนี้
...
%--------------------------
\section{ฟังก์ชันเคอรเนลและคุณสมบัติของเคอร์แนล}
%--------------------------
