...
วิธีแรกคือ Kernel Ridge Regression (KRR) โดยมีโมเดลทางคณิตศาสตร์คือ 
%
\begin{equation}
...
ในปัจจุบันมีบทความงานวิจัยที่ศึกษาการทำนายระดับพลังงานของโมเลกุลเป็นจำนวนมาก\autocite{pereira2017,stuke2019,chang2019,rahaman2020,moore2022,ye2022}
...
\noindent \textbf{ขั้นตอนที่ 3} สร้างโมเดลและกำหนด Loss Function
...
\idxth{การทำนายคุณสมบัติของโมเลกุล!การทำนายสเปกตรัม!อินฟราเรดสเปกโทรสโกปี}
...
\idxth{การทำนายคุณสมบัติของโมเลกุล!การทำนายสเปกตรัม!รามานสเปกโทรสโกปี}
...
\begin{table}[H]
    ...
    \begin{tabular}{cll}
        \toprule
        \textbf{ปี ค.ศ. ที่ตีพิมพ์} & \textbf{ผู้แต่งและบทความอ้างอิง}\footnotetext{ผู้แต่งในที่นี้คือนามสกุลของผู้แต่ง}  & \textbf{หัวข้อที่รีวิว}                       \\
        \midrule
