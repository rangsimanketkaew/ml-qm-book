...
\begin{enumerate}[topsep=0pt]
    ...
    \item คุณสมบัติเชิงโมเลกุลสำหรับสถานะเชิงอิเล็กทรอนิกส์ เช่น โครงสร้าง ณ สภาวะสมดุล (Equilibrium Structure), ไดโพล โมเมนต์ 
...
\begin{equation}\label{eq:ener_taylor}
    ...
    + \evaluated{\dv{E}{\epsilon}}_{\epsilon = 0} \epsilon
    + \frac{1}{2} \evaluated{\dv[2]{E}{\epsilon}}_{\epsilon = 0} \epsilon^{2}
    + \dots
\end{equation}
...
\begin{equation}
    \rho (\mathbf{r}) = 2 \sum_{i} \left ( \sum_{\mu} c_{\mu i} \phi_{\mu}^{*} \right ) 
    \left ( \sum_{\nu} c^{*}_{\nu i}  \phi_{\nu} \right )
\end{equation}
