...
\noindent โดยที่ $\psi$ คือฟังก์ชันคลื่นที่ถูกทำให้เป็นปกติ (Normalized Wavefunction) แล้ว
...
\begin{enumerate}[topsep=0pt]
    ...
    \item Density Functional Theory - An Advanced Course \\ แต่งโดย Eberhard Engel และ Reiner M. Dreizler
