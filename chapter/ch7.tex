...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/electron_density.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{fig/time-inde-schrodinger-eq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{fig/time-dep-schrodinger-eq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/hydrogen_density_plots.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{fig/scf.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fig/density_wavefunc_ener.png}
...
\noindent ก่อนอื่นให้สร้างฟังก์ชันสำหรับแสดงผลการคำนวณพลังงานในระหว่างการวนซ้ำ (Iteration)
...
\noindent กำหนดพารามิเตอร์เพิ่มเติม เช่น จำนวนรอบสูงสุดในการวนซ้ำและค่า Cutoff ของความแตกต่างระหว่างพลังงานจากรอบที่ $n$ และรอบที่ $n+1$
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/ks_dft_1d_wfn_ener.png}
    \caption{Wavefunction และพลังงานที่ได้จากการคำนวณ Kohn-Sham DFT สำหรับกรณี 1 มิติ}
    \label{fig:ks_dft_1d_wfn_ener}
\end{figure}

ผู้อ่านที่ต้องการศึกษาโค้ดฉบับสมบูรณ์สามารถดูได้ที่ไฟล์ \inlinehighlight{6_1D_DFT.ipynb} ใน Code Repository ของหนังสือที่ \url{https://github.com/rangsimanketkaew/ml-qm-book-code}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/jacob_ladder.jpg}
