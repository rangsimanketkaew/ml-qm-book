...
จริง ๆ แล้วถ้าหากผู้อ่านสังเกตภาพที่อยู่บนปกด้านหลังของหนังสือเล่มนี้จะพบว่าภาพนั้นคือปริภูมิเคมีของชุดข้อมูล QM9 นั่นเองซึ่งแสดงในภาพที่
\ref{fig:tmap_qm9} ซึ่งคำนวณด้วยวิธี Tree MAP (TMAP)\autocite{probst2020} นอกจากนี้ถ้าเราขยายเข้าไปใกล้ ๆ จะพบว่าจุดแต่ละ%
จุดนั้นคือโมเลกุลแต่ละโมเลกุล ตัวอย่างเช่น โมเลกุลที่แสดงในภาพที่ \ref{fig:tmap_qm9_zoom} ยิ่งจุดอยู่ใกล้กันมากเท่าไหร่ก็หมายความว่า%
โมเลกุลเหล่านั้นมีความเชื่อมโยงกันมากเท่านั้น และถ้าอยู่ห่างกัน (เช่น อยู่กันคนละกลุ่ม) ก็หมายความว่ามีความสัมพันธ์กันน้อย
...
\begin{table}[htbp]
    ...
    4 &mu &Debye &ไดโพล โมเมนต์ (Dipole moment) \\
