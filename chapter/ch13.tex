...
จากโค้ดด้านบนนั้นสิ่งที่เราจะได้ออกมาก็คือเมทริกซ์ที่แต่ละแถวนั้นจะบ่งบอกถึง Local Environment ของแต่ละอะตอมในโมเลกุล โดยความยาวของ 
Feature Vector ของ SOAP นั้นจะขึ้นอยู่กับจำนวนของ Species ที่เรากำหนดและขึ้นอยู่กับค่า $n_{\text{max}}$ และ $l_{\text{max}}$ 
ด้วย โดยผู้อ่านสามารถลองเปลี่ยนค่าของ $n_{\text{max}}$ และ $l_{\text{max}}$ เพื่อดูว่ามีผลต่อการเปลี่ยนค่าของ Feature Vector 
อย่างไร

นอกจากนี้เรายังสามารถเรียกใช้ Method \pyinline{derivatives} ของ Attribute \pyinline{soap} เพื่อคำนวณ Derivative ของ 
SOAP ได้ด้วย ดังนี้
...
โดยเฉพาะซึ่งสามารถใช้ \inlinehighlight{venv} หรือ \inlinehighlight{conda} ในการสร้าง Environment ได้ครับ}
...
Field ที่ผ่านการฝึกสอนมาแล้วหรือ Pre-trained Model (\inlinehighlight{m_ethanol.npz}) ได้โดยใช้คำสั่ง
