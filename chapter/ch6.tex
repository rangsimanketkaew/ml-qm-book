...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/cluster.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{fig/k-means-step1.png}
        \caption{เลือกค่าเฉลี่ย}
        \label{fig:k_means_step1}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{fig/k-means-step2.png}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{fig/k-means-step3.png}
        \caption{คำนวณค่าเฉลี่ยใหม่}
        \label{fig:k_means_step3}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{fig/k-means-step4.png}
...
\begin{enumerate}[topsep=0pt,noitemsep]\setlength\itemsep{0.5em}
    ...
    \item คำนวณหาระยะห่างที่สั้นที่สุดของข้อมูลทุกคู่ในกราฟโดยสามารถใช้การประมาณค่าระยะห่างแบบย่อย ๆ ได้ ตามภาพที่
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.4\linewidth]{fig/approx_geodesic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/diffusion_map.jpg}
    \caption{ภาพบน: ข้อมูลที่มีการกระจายอย่างไม่สม่ำเสมอบนเกลียวแบบวงแหวน (Toroidal Helix) ภาพล่าง: พิกัดของ Diffusion Map 2 อันดับแรกซึ่งมีการทำ Normalization โดยใช้เทคนิค Laplace-Beltrami Normalization ด้วย (เครดิตภาพ: \url{https://en.wikipedia.org/wiki/Diffusion_map})}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fig/autoencoder.pdf}
