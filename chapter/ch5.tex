...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth]{fig/ml-prediction.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth,page=2]{fig/ml-trade-off.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=1]{fig/cross_validation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=2]{fig/cross_validation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=3]{fig/cross_validation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=4]{fig/cross_validation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=5]{fig/cross_validation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth,page=6]{fig/cross_validation.pdf}
...
วิธีการทำ Data Augmentation นั้นจะตรงข้ามกับการทำความสะอาดข้อมูล (Data Cleaning) นั่นก็คือจะเป็นวิธีที่เราจะใส่ Noise หรือสิ่งที่ไม่ได้เกี่ยวข้องกับข้อมูลโดยตรงเข้าไปในชุดการฝึกสอน รวมไปถึงการแก้ไขข้อมูลให้แตกต่างไปจากเดิม แต่ยังคงไว้ซึ่งลักษณะของข้อมูลนั้น ซึ่งการทำ Data Augmentation จะเป็นการช่วยไม่ใช่ให้เกิดการเรียนรู้ที่มันยึดติดกับชุดข้อมูลฝึกสอนมากเกินไป ในปัจจุบันวิธีการนี้ได้รับความนิยมเพราะสามารถทำได้ง่าย สะดวก และไม่มีความซับซ้อนในการทำ โดยมีความจำเป็นอย่างยิ่งกรณีที่ชุดข้อมูลมีขนาดเล็ก (จำนวนข้อมูลไม่เยอะ) แต่ต้องการนำมาใช้ในการฝึกสอนด้วยเทคนิค ML ที่ต้องการข้อมูลในปริมาณที่เยอะในการฝึกสอน เช่น Deep Learning\autocite{bengio2021}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{fig/early_stopping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{fig/ensemble_method.png}
