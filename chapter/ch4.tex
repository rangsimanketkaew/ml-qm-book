...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/wisard.png}
...
เราจะทำการกำหนด Loss Function หรือ Coss Function ขึ้นมาก่อน โดยใช้ Least Square Cost Function สำหรับข้อมูลลำดับที่ $i$ นั่นก็คือคู่อันดับ $(x^{(i)} ,y^{(i)})$ ดังนี้
%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{fig/gradient_descent_path.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{fig/learning_rate_small.png}
        \caption{กรณีที่กำหนดให้ Learning Rate นั้นมีที่น้อยมาก ๆ}
        \label{fig:learning_rate_small}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{fig/learning_rate_high.png}
        \caption{กรณีที่กำหนดให้ Learning Rate นั้นมีที่สูงมาก ๆ}
        \label{fig:learning_rate_high}
    \end{subfigure}
    \caption{แสดงค่าคลาดเคลื่อน (Error หรือ Cost) เทียบกับการเปลี่ยนแปลงของการเรียนรู้ (เครดิตภาพ: https://www.oreilly.com)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/dense_neural_net.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{fig/nn_layer.png}
        \caption{ชั้นการเรียนรู้ (Learning Layer)}
        \label{fig:nn_layer}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{fig/nn_w_matrices.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{fig/nn_feedforward_matrices.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{fig/nn_feedforward_dyn_resizing.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{fig/nn_feedforward_matrix_weighted_input.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/nn_backprop.png}
...
\begin{equation}
  \sigma(z_i)
  = 
  \frac{e^{z_{i}}}{\sum_{j=1}^K e^{z_{j}}} \ \ \ \texttt{for}\ i=1,2,\dots,K
\end{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{fig/least-squares-fitting.png}
...
\end{equation}
%
\noindent เมื่อเราทำการคูณสมการที่ \eqref{eq:der_loss_pred} กับ \eqref{eq:der_loss_pred} เข้าด้วยกัน เราจะได้อนุพันธ์ของ Loss Function ตามที่ต้องการ
%
...
\noindent และเขียนโค้ดของฟังก์ชันได้ดังนี้\footnote{โดยทั่วไปแล้วในการคำนวณหา Error ของ Logistic Regression ควรจะทำการใส่ค่าคงที่เข้าไปในฟังก์ชัน Log เพื่อป้องกันไม่ให้อินพุตของ Log นั้นเป็น 0}
...
นอกจากนี้ RNN ยังได้ถูกนำไปพัฒนาต่อให้มีประสิทธิภาพมากขึ้น โดยมีอีก 2 สถาปัตยกรรมย่อยที่ได้รับความนิยม คือ Long Short-Term Memory (LSTM)\autocite{hochreiter1997a} และ Echo State Network (ESN)\autocite{jaeger2004}
