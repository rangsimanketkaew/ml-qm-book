...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/delta_ml_base_target.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/attention_1_self.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/attention_2_masked.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/attention_3_enc-dec.png}
