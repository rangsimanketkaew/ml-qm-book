...
\begin{table}[H]
    ...
    GAP &\url{https://github.com/libAtoms/QUIP} &Bartók and Csányi\autocite{bartok2010} \\
    \multirow{2}{*}{SNAP} &\url{https://lammps.sandia.gov/doc/pair_snap.html} 
    &\multirow{2}{*}{Thompson et al.\autocite{thompson2015}} \\
    &\url{https://github.com/materialsvirtuallab/snap} & \\
    AENET &\url{http://ann.atomistic.net} &Artrith and Urban\autocite{artrith2016} \\
    AGNI &\url{https://lammps.sandia.gov/doc/pair_agni.html} &Huan et al.\autocite{huan2017} \\
    PROPhet &\url{https://github.com/biklooost/PROPhet} &Kolb et al.\autocite{kolb2017} \\
    TensorMol &\url{https://github.com/jparkhill/TensorMol} &Yao et al.\autocite{yao2018} \\
    ANI &\url{https://github.com/isayev/ASE_ANI} &Smith et al.\autocite{smith2017} \\
    COMP6 &\url{https://github.com/isayev/COMP6} &Smith et al.\autocite{smith2018} \\
    DeePMD-kit95 &\url{https://github.com/deepmodeling/deepmd-kit} &Wang et al.\autocite{wang2018} \\
    VAMPnet &\url{https://github.com/markovmodel/deeptime} &Mardt et al.\autocite{mardt2018} \\
    CGCNN &\url{https://github.com/txie-93/cgcnn} &Xie and Grossman\autocite{xie2018} \\
    ElemNet &\url{https://github.com/dipendra009/ElemNet} &Jha et al.\autocite{jha2018} \\
    OQMD-SC &\url{https://github.com/dipendra009/ElemNet} &Jha et al\autocite{jha2019} \\
    \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \midrule
    AFLOWLIB &\url{https://aflow.org/aflow-ml} &Curtarolo et al.\autocite{curtarolo2012} \\
    Materials project &\url{https://materialsproject.org} &Jain et al.\autocite{jain2013} \\
    OQMD &\url{https://oqmd.org} &Kirklin et al.\autocite{kirklin2015} \\
    libAtoms &\url{https://github.com/libAtoms} &Bartók et al.\autocite{bartok2018} \\
    Matminer &\url{https://github.com/markovmodel/deeptime} &Ward et al.\autocite{ward2018} \\
    Chemical VAE &\url{https://ccs-psi.org/node/22} 
    &Gómez-Bombarelli et al.\autocite{gomez-bombarelli2018} \\
    JARVIS-DFT &\url{https://github.com/usnistgov/jarvis} &Choudhary et al.\autocite{choudhary2018} \\
    DScribe &\url{https://github.com/SINGROUP/dscribe} &Himanen et al.\autocite{himanen2020} \\
    NOMAD &\url{https://analytics-toolkit.nomad-coe.eu} &Draxl and Scheffler\autocite{draxl2019} \\
    OMDB &\url{https://omdb.mathub.io/dataset} &Olsthoorn et al.\autocite{olsthoorn2019} \\
    Khazana &\url{https://khazana.gatech.edu} &Chapman et al.\autocite{chapman2020} \\
    MolDis &\url{https://moldis.tifrh.res.in/index.html} &Kayastha and Ramakrishnan\autocite{kayastha2021} \\
    \bottomrule
    \end{tabular}
\end{table}
