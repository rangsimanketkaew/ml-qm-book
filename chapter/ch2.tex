...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{fig/supervised_ml.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{fig/plot_multivar_reg.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{fig/svm.png}
